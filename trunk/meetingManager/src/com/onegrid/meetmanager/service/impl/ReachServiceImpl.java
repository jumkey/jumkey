...
import com.onegrid.meetmanager.dao.LotteryDAO;
import com.onegrid.meetmanager.dao.MeetingInfoDAO;
import com.onegrid.meetmanager.dao.RegisterDAO;
import com.onegrid.meetmanager.dao.SendNotificationPlanDAO;
...
import com.onegrid.meetmanager.model.Lottery;
...
import com.onegrid.meetmanager.service.ReachService;
import com.onegrid.meetmanager.utils.RandomAwardToolkits;
...
public class ReachServiceImpl implements ReachService {
	...
	public List<Reach> getReachsByMeetingId(Integer id) {
		List<Reach> l = registerDAO
				.findReachs("select new com.onegrid.meetmanager.model.Reach(i, s, r) "
